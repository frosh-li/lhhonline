...
/**
 * This is the model class for table "supe_mh_spaceitems".
 *
 * The followings are the available columns in table 'supe_mh_spaceitems':
 ...
 */
class mhItems extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return mhItems the static model class
	 */
