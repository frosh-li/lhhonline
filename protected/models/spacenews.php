...
/**
 * This is the model class for table "supe_mainspacenews".
 *
 * The followings are the available columns in table 'supe_mainspacenews':
 ...
 */
class spacenews extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return spacenews the static model class
	 */
