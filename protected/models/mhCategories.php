...
/**
 * This is the model class for table "supe_mh_categories".
 *
 * The followings are the available columns in table 'supe_mh_categories':
 ...
 */
class mhCategories extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return mhCategories the static model class
	 */
