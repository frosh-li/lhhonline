...
/**
 * This is the model class for table "supe_mh_tags".
 *
 * The followings are the available columns in table 'supe_mh_tags':
 ...
 */
class mhTags extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return mhTags the static model class
	 */
