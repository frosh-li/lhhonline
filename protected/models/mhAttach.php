...
/**
 * This is the model class for table "supe_mh_attachments".
 *
 * The followings are the available columns in table 'supe_mh_attachments':
 ...
 */
class mhAttach extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return mhAttach the static model class
	 */
