...
/**
 * This is the model class for table "supe_mh_spacenews".
 *
 * The followings are the available columns in table 'supe_mh_spacenews':
 ...
 */
class mhNews extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return mhNews the static model class
	 */
